  ...
  protected move(vcase?: Case) {
    ...
    if (nextPage) {
      ...
      if (nextIdx < 0) {
        ...
        let currentPageIndex = this._engageform.getPageIndex(page)
        return super.move(vcase, currentPageIndex > nextIdx ? nextIdx + 1 : (nextIdx - currentPageIndex), currentPageIndex > nextIdx)
      }
    }
